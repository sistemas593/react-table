...
import { findAllPages, remove, save, update } from "../services/clienteService";
...
export const useClientes = () => {
    ...
    const { clientes, selected, visibleForm, errors, isLoading, paginator } = useSelector(state => state.clientes);
